      ...
      <div className="relative">
        <div className="absolute inset-0">
          <img
            ...
            className="w-full h-[12.5rem] sm:h-[14rem] object-cover bannner-posit-mobile sm:bannner-posit"
          />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-[2.7rem]">
          ...
          <h1 className="text-2xl sm:text-4xl font-semibold text-white mb-2 sm:mb-4">Product Development Courses</h1>
