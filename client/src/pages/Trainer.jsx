            ...
            <div className='bg-[#FAFAFA]'>
                <div className="bg-mint-50 min-h-screen">
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
                        ...
                        <div className="absolute top-[250px] right-[68px] w-0 h-0 z-0">
                            <svg width="91" height="70" viewBox="0 0 91 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5'>
                        <div className="flex justify-between items-center mb-16">
                            <div className="flex items-center text-[#1E1E1E] font-medium text-xl">
                                <span>Empower and Inspire the Next Generation of Tech Professionals</span>
                                <HiArrowLongRight className="ml-2 h-8 w-8" />
                            </div>
                            <button className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-4  rounded-xl transition-colors" onClick={openModal}>
                    ...
                    <div className='bg-white w-full'>
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                            ...
                            <div className="grid md:grid-cols-3 gap-8">
                                ...
                                <div className="flex flex-col items-start text-start border border-[#F1F1F1] p-5">
                                    <div className="mb-4">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-6">
                            {success ? (
                                <div className="text-green-600 font-semibold text-lg py-8 text-center">
                                    Application submitted successfully! We will be in touch soon.
                                    <button className="mt-6 px-6 py-2 bg-teal-600 text-white rounded-md" onClick={() => { setSuccess(false); closeModal(); }}>Close</button>
                                </div>
                            ) : (
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {[0, 1, 2, 3, 4, 5, 6, 7].map((rating) => (
                                                <label key={rating} className="flex items-center justify-center w-10 h-10 border border-gray-300 rounded-full hover:bg-gray-50">
                                                    <input type="radio" name="skillRating" value={rating} checked={formData.skillRating == rating} onChange={handleChange} className="sr-only" />
                                                    <span>{rating}</span>
                                                </label>
                                            ))}
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                                            {['Not Confident', 'Slightly Confident', 'Moderately Confident', 'Confident', 'Very Confident'].map((val) => (
                                                <label key={val} className="flex items-center justify-center p-2 border border-gray-300 rounded-md hover:bg-gray-50">
                                                    <input type="radio" name="confidence" value={val} checked={formData.confidence === val} onChange={handleChange} className="sr-only" />
                                                    <span>{val}</span>
                                                </label>
                                            ))}
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                                            {['Less than 1 month', '1 - 2 months', '3 - 4 months', '5 - 6 months', 'More than 6 months'].map((val) => (
                                                <label key={val} className="flex items-center justify-center p-2 border border-gray-300 rounded-md hover:bg-gray-50">
                                                    <input type="radio" name="prepTime" value={val} checked={formData.prepTime === val} onChange={handleChange} className="sr-only" />
                                                    <span>{val}</span>
                                                </label>
                                            ))}
                                        </div>
