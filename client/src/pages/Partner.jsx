      ...
      <div className="bg-mint-50 min-h-screen">
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5'>
          <div className="flex justify-between items-center mb-16">
              <div className="flex text-xl items-center text-[#1E1E1E] font-semibold">
              <span>Transform Lives and Shape the Future of Tech Education</span>
              <ArrowRight className="ml-2 h-5 w-5" />
              </div>
              <button className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-4 font-semibold rounded-xl transition-colors" onClick={openModal}>
        ...
        <div className="flex justify-between items-center mb-16">
          <div className="flex items-center text-[#1E1E1E] font-medium text-xl">
            ...
            <HiArrowLongRight className="ml-2 h-5 w-5 font-bold" />
          </div>
          <button className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-4 font-semibold rounded-md transition-colors" onClick={openModal}>
          Partner With Us Today
          </button>
        </div>
        </div>
