...
const WaitlistModal = ({
  ...
  const handleCleanSubmit = async (e) => {
    ...
    const payload = {
      ...
      preferredCohort: formData.cohortId
    };
        ...
        {modalStep === "notice" && (
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <h4 className="font-semibold text-gray-900 text-base">2. WAITLIST PROCESS</h4>
                <div className="text-gray-600 text-sm space-y-2">
                  <p>By joining the waitlist, you will:</p>
                  <ul className="space-y-2 pl-1">
                    <li className="flex items-start gap-2">
                      <span className="text-teal-600 mt-0.5">✔</span>
                      <span>Be notified when a spot becomes available in your preferred course.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-teal-600 mt-0.5">✔</span>
                      <span>Have priority access to enrollment when positions open up.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-teal-600 mt-0.5">✔</span>
                      <span>Need to complete the full application process once a spot is available.</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <h4 className="font-semibold text-gray-900 text-base">3. CONFIRMATION</h4>
                <p className="text-gray-600 text-sm">
                  Once you join the waitlist, you'll receive a confirmation email. When a spot becomes available,
                  we'll contact you with next steps to complete your enrollment.
                </p>
              </div>
