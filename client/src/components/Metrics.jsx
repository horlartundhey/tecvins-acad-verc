      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="bg-white p-8 rounded-lg flex flex-col items-center">
            <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center mb-4">
              <HiCalendarDays className="h-6 w-6 text-[#0072DF]" />
            </div>
          ...
          <div className="bg-white p-8 rounded-lg flex flex-col items-center">
            <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center mb-4">
              <HiGlobeAlt className="h-6 w-6 text-[#00BC85]" />
            </div>
          ...
          <div className="bg-white p-8 rounded-lg flex flex-col items-center">
            <div className="w-12 h-12 rounded-full bg-red-100 flex items-center justify-center mb-4">
              <IoBriefcaseOutline className="h-6 w-6 text-red-500" />
            </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 font-semibold">
            <a
              href="/support"
              className="px-6 py-3 rounded-lg border border-white text-white hover:bg-white hover:text-[#1a4741] transition-colors"
            >
              Support Us
            </a>
            ...
            <a
              href="/courses"
              className="px-6 py-3 rounded-lg bg-white text-[#1a4741] hover:bg-gray-100 transition-colors flex items-center justify-center"
            >
