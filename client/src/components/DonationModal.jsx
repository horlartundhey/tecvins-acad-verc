...
const DonationModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white rounded-lg w-full max-w-[56rem] max-h-[95vh] sm:max-h-[90vh] flex flex-col overflow-hidden">
        {/* Fixed Header */}
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2.5 text-base border rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                min="0"
                step="0.01"
                className={`w-full pl-8 pr-3 py-2.5 text-base border rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 ${
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Write..."
              rows="3"
              className="w-full px-3 py-2.5 text-base border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 resize-none"
            />
          </div>
          ...
          <div className="flex items-center text-sm text-gray-600">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              <button
                ...
                className="flex-1 bg-teal-600 hover:bg-teal-700 disabled:bg-teal-400 text-white font-semibold py-3 px-4 rounded-md transition-colors text-base"
              >
              ...
              <button
                type="button"
                onClick={onClose}
                className="flex-1 border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold py-3 px-4 rounded-md transition-colors text-base"
              >
                Cancel
              </button>
            </div>
