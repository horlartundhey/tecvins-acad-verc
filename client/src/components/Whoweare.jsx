        ...
        <section className="py-16 bg-white relative overflow-hidden">
          <div className="container mx-auto px-4 max-w-7xl relative z-10">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="max-w-xl relative">
                ...
                <div className="relative z-10">
                  <h2 className="text-3xl md:text-4xl font-bold text-[#0F2624] mb-6">Who Are We?</h2>

                  <div className="space-y-4 text-[#5E5E5E] text-base md:text-lg">
                    <p>
              ...
              <div className="relative">
                ...
                <div className="relative w-[500px]">
                  ...
                  <div className="custom-frame-who">
                    ...
                    <div className="absolute top-0 right-[68px] w-0 h-0 z-0">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-between gap-4">
              <Link
                to="/about"
                className="flex items-center text-[#1E1E1E] font-medium text-xl hover:text-gray-600 transition-colors"
              >
              ...
              <Link
                to="/about"
                className="inline-flex items-center px-6 py-2 rounded-xl border border-[#C8C8C8] text-[#3B9790] hover:bg-teal-50 transition-colors font-semibold"
              >
                Learn more about us
                <HiArrowLongRight className="w-5 h-5 ml-3" />
              </Link>
            </div>
          </div>
