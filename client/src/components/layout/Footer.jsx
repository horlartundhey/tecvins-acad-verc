            ...
            {/* Social Links */}
              <div className="ml-0 md:ml-auto">
                ...
                <div className="flex gap-4">
                  <a href="https://www.linkedin.com/company/tecvinson-academy/" className="text-gray-600 hover:text-gray-800" aria-label="LinkedIn">
                    <svg
                  ...
                  <a href="https://www.facebook.com/tecvinsonac/" className="text-gray-600 hover:text-gray-800" aria-label="Facebook">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
                  ...
                  <a href="https://www.instagram.com/tecvinsonac/" className="text-gray-600 hover:text-gray-800" aria-label="Instagram">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
                  ...
                  <a href="https://x.com/tecvinsonac" className="text-gray-600 hover:text-gray-800" aria-label="Twitter/X">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
